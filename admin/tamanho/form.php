<?php
  ...
  if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    // endpoint da API
    $end_point = "http://localhost/api_back/produtos/tamanho/?id=$id";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Inserir Tamanho</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tamanhos</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form action="salvar.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">	
                      ...
                      <input type="text" id="tamanho" name="tamanho" value="<?php echo $tamanho ?>" class="form-control" placeholder="Informe nome da cor">
                    </div>
                  </div>
