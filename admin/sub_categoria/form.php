...
//  exit;
    ...
    if ($dado['status']=='success'){
      $sub_categoria = $dado["sub_categoria"]['sub_categoria'];
    }
    else{
      $status = "fail";
      $msg = $dados["Error"];
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Inserir Sub Categoria</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <form action="salvar.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">	
                      ...
                      <input type="text" id="sub_categoria" name="sub_categoria" value="<?php echo $sub_categoria ?>" class="form-control" placeholder="Informe nome da sub categoria">
                    </div>
                  </div>
