              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th><?php echo $registro["pk_cor"]; ?></th>
                      <td><?php echo $registro["cor"]; ?></td>
                      <td>
                        <a href="form.php?id=<?php echo $registro["pk_cor"]; ?>" class="btn btn-secondary"><i class="fas fa-pen"></i> ALTERAR</a> 
                        <a href="delete.php?id=<?php echo $registro["pk_cor"]; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i> EXCLUIR</a>
                      </td>
                    </tr>
