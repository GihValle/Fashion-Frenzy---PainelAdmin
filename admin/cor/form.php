<?php
  ...
  if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    // endpoint da API
    $end_point = "http://localhost/api_back/produtos/cor/?id=$id";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Inserir Cor</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <form action="salvar.php" method="post" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group">	
                      ...
                      <input type="text" id="cor" name="cor" value="<?php echo $cor ?>" class="form-control" placeholder="Informe nome da cor">
                    </div>
                  </div>
