            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th><?php echo $registro["pk_produto"]; ?></th>
                    <td><?php echo $registro["nome"]; ?></td>
                    <td><?php echo $registro["desc_produto"]; ?></td>
                    <td><?php echo $registro["valor"]; ?></td>
                    <td><?php echo $registro["marca"]; ?></td>
                    <td><?php echo $registro["categoria"]; ?></td>
                    <td><?php echo $registro["sub_categoria"]; ?></td>
                    <td><?php echo $registro["genero"]; ?></td>
                    <td>
                      <a href="form.php?id=<?php echo $registro["pk_produto"]; ?>" class="btn btn-secondary"><i class="fas fa-pen"></i>ALTERAR</a>
                      <a href="delete.php?id=<?php echo $registro["pk_produto"]; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i>EXCLUIR</a> 
                    </td>
                  </tr>
