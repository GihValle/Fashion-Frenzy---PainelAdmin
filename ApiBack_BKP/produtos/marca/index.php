<?php
    ...
    if($method == "GET"){
        ...
        if(!isset($_GET["id"])){
            ...
            try{
                ...
                throw new ErrorException("Marca inválida", 1);
                }
    ...
    if($method == "POST"){
        ...
        $marca = trim($dados->marca);   //Acessa o valor de um OBJETO 
    ...
    if($method == "PUT"){
        ...
        try {
            ...
            if(empty($dados->marca)){
                //Está vazio: ERRO
                throw new ErrorException("Nome de Marca é um campo obrigatório", 1);
            }
