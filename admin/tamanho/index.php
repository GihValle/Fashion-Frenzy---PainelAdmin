<?php
  ...
  $end_point = "http://localhost/api_back/produtos/tamanho/";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Tamanho</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th><?php echo $registro["pk_tamanho"]; ?></th>
                      <td><?php echo $registro["tamanho"]; ?></td>
                      <td>
                        <a href="form.php?id=<?php echo $registro["pk_tamanho"]; ?>" class="btn btn-secondary"><i class="fas fa-pen"></i> ALTERAR</a> 
                        <a href="delete.php?id=<?php echo $registro["pk_tamanho"]; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i> EXCLUIR</a>
                      </td>
                    </tr>
